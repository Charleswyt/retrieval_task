...
pos_file_name = 'data/pos.xls'
neg_file_name = 'data/neg.xls'

## 文本输出
pos = xlwt.Workbook(encoding = 'utf-8', style_compression = 0)
neg = xlwt.Workbook(encoding = 'utf-8', style_compression = 0)
sheet1 = pos.add_sheet('pos', cell_overwrite_ok = True)
sheet2 = neg.add_sheet('neg', cell_overwrite_ok = True)
